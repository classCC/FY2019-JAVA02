...
import com.wz.alipay.Main;
import com.wz.common.*;
import com.wz.dao.OrderItemMapper;
import com.wz.dao.OrderMapper;
import com.wz.dao.PayInfoMapper;
import com.wz.pojo.*;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse createOrder(Integer userId, Integer shippingId) {
        ...
        if(cartList==null|| cartList.size()==0){
            return  ServerResponse.serverResponseByError(ResponseCode.ERROR,"购物车为空或者未选中购物车中的商品");
        }
    ...
    public ServerResponse pay(Order order) {
        ...
        if (orderItemList==null||orderItemList.size()==0){
            return ServerResponse.serverResponseByError(ResponseCode.ERROR,"没有购买的商品");
        }
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setNotifyUrl("http://922rx4.natappfree.cc/order/callback")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
